...
# Part I: Classification Algorithm for the Status of the Patient
...
-   Class 0 (D): The patient didn't survive.
...
In this report, I have decided to use {rpart} because it provides more flexibility for surrogate splits and the trees are a bit easier to make attractive looking.
...
(Explanation of above) To gain a further understanding of the data, we can plot a tree yielding Collection Node style trees. This can help us understand how the data is split.
...
From the graph we can see that a cp of 0.011 is ideal as it is under the horizontal (dotted) reference line. We can prune the tree with this CP value.
...
-   True Positive (TP): Predicted Graduated and actually Graduated. In this case, 2217

-   False Positive (FP): Predicted Graduated but actually Not Graduated. In this case, 1000

-   False Negative (FN): Predicted Not Graduated but actually Graduated. In this case, 244

-   True Negative (TN): Predicted Not Graduated and actually Not Graduated. In this case, 659
