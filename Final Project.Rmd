...
Cirrohosis is a condition where the liver is scarred and permanently damaged. As this condition, chances of liver failure and liver cancer increase. We are intrested in creating model that can predict stages of Cirrohosis and also death based on certain conditions. We hope our work can be useful in catching Cirrosis earlier on. 
